  ...
  return (
    <div className=" max-w-full bg-black text-white mx-auto py-5">
      <div className="max-w-7xl flex flex-col md:flex-row justify-between mx-auto  ">
        <button className="ml-3 " data-aos="zoom-in">
          MASUM <span className="text-red-600 font-bold text-xl ">|</span>{" "}
          FITNESS
        </button>

        <div className="flex  md:w-3/4  mt-5  md:mt-0 justify-between " data-aos="fade-right">
          <NavLink
            to="/"
          ...
          {user ? (
            <>
              ...
              <div className="flex gap-3 items-center">
                {user.photoURL ? (
                  <img src={user.photoURL} className="w-6 md:w-10 rounded-full"  data-aos="fade-right"/>
                ) : (
                  <img
